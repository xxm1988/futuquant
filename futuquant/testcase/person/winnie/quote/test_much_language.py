...
class TestMuchLanguage():
    ...
    def test_quote(self):
        ...
        # 3、未知的股票
        print(self.quote_ctx.subscribe('hk.00700', SubType.BROKER))
        self.quote_ctx.get_broker_queue('hk.00700')
        # 4、请求股票个数超过限制get_owner_plate
        self.quote_ctx.subscribe('HK.00700',SubType.K_1M)
        print(self.quote_ctx.get_cur_kline('HK.00700',1001,SubType.K_1M,AuType.QFQ))
        # 5、本地数据库不存在
    ...
    def test_trade(self):
        ...
        # 3、已经是解锁状态13955235245b2497
        print(self.trade_ctx_hk.unlock_trade(password='13955235245b2497', password_md5='13955235245b2497'))
        print(self.trade_ctx_hk.unlock_trade(password='13955235245b2497', password_md5='13955235245b2497'))
        # 4、数量不合法
